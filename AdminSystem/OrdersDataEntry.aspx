...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtOrderNo" runat="server" Height="25px" style="margin-left: 40px" Width="184px"></asp:TextBox>
        <asp:Button ID="btnfind" runat="server" OnClick="Button1_Click" style="margin-left: 36px" Text="Find" Width="150px" />
        <p>
