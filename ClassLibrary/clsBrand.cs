...
namespace ClassLibrary {
    ...
    public class clsBrand
    {
        ...
        public int BrandID { get { return brandId; } private set { brandId = value; } } // cannot set this outside of class, the DB assigns the number, this class will fetch the num to be set here.
        ...
        public void AddToDatabase(clsBrand brand)  
        {
            ...
            string sqlRestockDate = "'" + brand.LastRestock.Year + "-" + brand.LastRestock.Month + "-" + brand.LastRestock.Day + "'";
            clsDataConnection connection = new clsDataConnection();
        ...
        {
            return BrandID.GetHashCode() + BrandName.GetHashCode() * 29;
        }
    }
